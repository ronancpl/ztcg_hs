ZTCG_CARD
{
    ...
    function undoBuffs(player)
        ...
        removeAuraBonus(player, "GLOBALAURA_PASS_ADVSRY",src,0,0,10,0,"ZTCG_DONTCARE","ZTCG_DONTCARE","TYPE_CHA", "ELEM_ANY", "ZTCG_NIL")
    end

    function applyBuffs(player)
        local src = getSourceCARD()
        applyAuraBonus(player, "GLOBALAURA_PASS_ADVSRY",src,0,0,10,0,"ZTCG_DONTCARE","ZTCG_DONTCARE","TYPE_CHA", "ELEM_ANY", "ZTCG_NIL")
    end
