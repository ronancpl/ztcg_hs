ZTCG_CARD
{
    ...
    function onThinkAction(player)
        ...
        local top_card = takeCardsFromDeck(deck, 1)

        local mobs, notEmpty = makeFilteredTableList(player,"ONLY_ADVSRY",0,"ZTCG_DONTCARE","ZTCG_DONTCARE","TYPE_MOB","ELEM_ANY","ZTCG_NIL")
        if notEmpty then
            ...
            if mob ~= 0 then
                ...
                table_mob = moveCardsFromListToDeck(table_mob,deck,"TAKE_NEXT","PUT_TOP","ZTCG_MAXVALUE")
                top_card = moveCardsFromListToDeck(top_card,deck,"TAKE_NEXT","PUT_TOP","ZTCG_MAXVALUE")
